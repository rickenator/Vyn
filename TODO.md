...
| Async/await | ~98% | agents (message-passing units) — design doc (`doc/AGENTS_DESIGN.md`); Stages 1-3 (core shape, Int/Bool/Float/String payloads, request/response + composition) shipped (`test/agents/`); Stages 4-5 pending |
