...
| Standard library | ~60% | Vec, String, HashMap/HashSet, BTreeMap, File I/O, Math, TCP socket I/O, time done; async/higher-level networking pending |
