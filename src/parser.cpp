...
BaseParser::BaseParser(const std::vector<Token>& tokens) : tokens_(tokens), pos_(0) {}
...
ExpressionParser::ExpressionParser(const std::vector<Token>& tokens, size_t& pos) : BaseParser(tokens), shared_pos_(pos) {}
...
TypeParser::TypeParser(const std::vector<Token>& tokens, size_t& pos) : BaseParser(tokens), shared_pos_(pos) {}
...
StatementParser::StatementParser(const std::vector<Token>& tokens, size_t& pos) : BaseParser(tokens), shared_pos_(pos) {}
...
DeclarationParser::DeclarationParser(const std::vector<Token>& tokens, size_t& pos) : BaseParser(tokens), shared_pos_(pos) {}
...
ModuleParser::ModuleParser(const std::vector<Token>& tokens) : BaseParser(tokens) {}
