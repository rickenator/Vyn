...
| Stdlib process module (`process`) | ✅ | Run a trusted command line through the shell — `exec_run` (exit code or -1), `exec_output` (captured stdout), `exec_status` (`import process`, `test/process/test_process.vyb`) |
...
*Last updated: v0.7.2 (2026-08-17)*
