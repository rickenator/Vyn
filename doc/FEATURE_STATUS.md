...
| `match` / `select` expressions | ✅ | Literal, wildcard, comparison, and struct-destructuring patterns (`Point { x, y } ->` binds fields in the arm body; unknown fields and type mismatches are rejected) |
| `defer` | ✅ | |
